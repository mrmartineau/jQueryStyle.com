		<div id="paging" class="group">
			<a href="#" title="Page 1">Latest</a>
		</div><!-- /paging -->

		<div id="level_1_container" style="display:none;">
			<div id="level_1"></div>
		...
		<div id="social">
			...
			<div class="fb-like" data-href="http://jquerystyle.com" data-send="false" data-layout="box_count" data-width="55" data-show-faces="false" data-font="lucida grande"></div>
			<script src="http://www.stumbleupon.com/hostedbadge.php?s=5&r=http://jquerystyle.com"></script>
			<script type="text/javascript">
