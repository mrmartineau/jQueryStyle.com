...
class stung_theme extends classic_theme
{
	function html_head()
	{
		$js = <<<SF
...
SF;
	...
	function footer()
	{
		return '</div>'.n.
			'<div id="end_page">'.n.
			'<a href="http://j.mp/aufgmS" id="mothership"><img src="theme/stung/carver.gif" width="60" height="48" border="0" alt="" /></a>'.n.
			graf('Textpattern &#183; '.txp_version).n.
			'<p id="themeBy"><a href="http://j.mp/9c0UO6">This is the Textpattern <span>&ldquo;Stung&rdquo;</span> admin theme designed by Zander Martineau</a></p>'.n.
